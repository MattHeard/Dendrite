...
public class ContentsView extends View {
	...
	public List<Link> getLinks() {
		if (this.links == null) {
			...
			final List<List<String>> tags = this.getTags();
	...
	private List<List<String>> getTags() {
		final List<List<String>> tagsList = new ArrayList<List<String>>();
		List<StoryBeginning> beginnings = this.getBeginnings();
		for (final StoryBeginning b : beginnings) {
			final List<String> tags = b.getTags();
			tagsList.add(tags);
		}
		return tagsList;
	}
