...
<html>
  ...
  <body>
    ...
    <p>You have found one of the most amazing places on the Web where you can
      share your ideas, stories and dreams with millions of other people around
      the world. You are now part of the "Dendrite Community."</p>
    <p>Our Website is owned and managed by <b>Deuterium Labs Limited</b>
      (<b>we</b>, <b>us</b> or <b>our</b>). We have a common set of community
      rules or terms that all our community members and users of this Website
      must adhere to at all times. These rules are set out in these Terms of
      Use.</p>
    <p>These terms apply to your access to, and use of, this Website. If you
      continue to use this Website you are agreeing to comply with and be bound
      by these terms.</p>
    <p>These terms may be amended by us without notice from time to time.
      Amendments will be effective at the time the amended terms are posted on
      this Website. You are responsible for ensuring you are aware of the terms,
      so please check regularly for any updates.</p>
    ...
    <ul>
      <li>upload, post or otherwise transmit or disseminate any photos,
        software, material, comment or information that is unlawful, tortious,
        obscene, vulgar, defamatory, pornographic, indecent, lewd, harassing,
        threatening, hateful, harmful, invasive of privacy or publicity rights,
        abusive, inflammatory, or racially, ethnically or otherwise
        objectionable;</li>
      <li>infringe the copyright or other intellectual property rights, or
        confidential information, of any other person;</li>
      <li>defame, abuse, harass, stalk, threaten or otherwise violate the legal
        rights of others, including any breach of privacy or the principles of
        data protection;</li>
      <li>interfere with the operation of this Website via the use of viruses,
        ...
        hardware, including damaging, disabling, overburdening or impairing this
        Website or interfering with any other party's use and enjoyment of this
        Website;</li>
      ...
      <li>use this Website for commercial venture, advertisement, promotion, or
        gain of any kind (whether or not for money or other reward).</li>
    </ul>
    <h3>Content on this Website</h3>
    <p>You may view and create any Content on this Website. <b>"Content"</b>
      means any text, information or other material which is capable of being
      uploaded onto this Website. You may add your Content to any other users'
      contributions of Content.</p>
    <p>You own all intellectual property in your own original Content you
      contribute. You must not upload or contribute any Content not originally
      created by you, or any Content which is not properly licensed to you by
      someone else for uploading or contributing.</p>
    <p>All Content you upload or contribute is licensed to us and all other
      users and viewers of this Website, to use and enjoy under these Terms of
      Use. You agree that this licence cannot be cancelled or revoked, does not
      expire, is freely granted and has world-wide application.</p>
    ...
    <p>We do not guarantee that this Website will be accessible, nor will have
      any specific up-time, availability or latency characteristics. The Website
      may be down from time to time for maintenance.</p>
    <p>We have no responsibility or liability for any Content on this Website.
      Any person objecting to or having any issue or claim in relation to any
      Content should immediately contact us at
    ...
    <p>From time to time this Website may include links to other websites. Those
      websites are not under our control. The links are provided for your
      convenience only. We do not endorse, and are not responsible for the
      content, validity, accuracy or your use of, those websites. You should
      check the terms and conditions of use of those websites before you use
      them.</p>
    <h3>Privacy</h3>
    <p>We may collect and retain personal information provided by you through
      ...
      through the use of cookies to record your visit. All information collected
      will be held by us in accordance with our <a href="/privacy.jsp">Privacy
      Policy</a>.</p>
    ...
    <p>We are the owners, or are licensed users, of all intellectual property
      ...
      limited to) the copyright material, patents and trademarks used to operate
      this Website – but excluding all Content contributed to or uploaded by
    ...
    <p>You agree and acknowledge that you will not reproduce, store, distribute,
      display, or publish works from this Website or any or its Content without
      our prior written permission, and also the permission of any contributing
      user (in respect of any Content).</p>
    <p>Unless otherwise stated, you are permitted to access, view, copy, print
      (in limited quantities) or temporarily store textual material and Content
      made available by us on this Website for your personal use only. Any
      copyright notice in respect of that information or Content must be
      retained on the copy.</p>
    <h3>Exclusion of our liability</h3>
    <p>You acknowledge and agree that:</p>
    <ul>
      <li>to the maximum extent permitted at law, any and all liability of us
        and our directors, officers and employees to you under or in connection
        with these terms, this Website, all Content or your use of this Website
        is excluded; and</li>
      <li>the exclusion in the paragraph above applies regardless of whether
        liability arises in contract, tort (including negligence), equity or by
        statute or other legislation, and whether such liability is for direct,
        indirect, consequential or punitive losses or damages, or loss of
        profit, income, data, business opportunity or anticipated savings.</li>
    </ul>
    <p>All warranties, whether express or implied, as to the accuracy, currency,
      completeness, fitness for purpose or usefulness of the information
      contained in this Website or its Content are excluded to the extent
      permitted by law.</p>
    <p>It is up to you to ensure you are protected against viruses, worms,
      Trojan horses, spyware, malware or other items of a destructive or harmful
      nature.</p>
    <h3>Your indemnity</h3>
    <p>You agree to indemnify, and keep indemnified, us and our directors,
      officers and employees against any and all actions, claims, proceedings,
      losses, liabilities, damages, costs and expenses (including legal costs)
      suffered or incurred by any of those persons arising out of or in
      connection with:</p>
    <ul>
    ...
    <h3>Severability</h3>
      <p>If any provision of these terms and conditions becomes or is held
        ...
        reason, that provision (or part of that provision) will be severed from
        the remaining terms and conditions, which will continue in full force
        and effect.</p>
    <h3>Governing law</h3>
