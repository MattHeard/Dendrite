...
<html>
  ...
  <body>
    ...
    if (isUserLoggedIn == true) {
        ...
        userFontSize = TermsView.getUserFontSize();
        userFontType = TermsView.getUserFontType();
        userFontColour = TermsView.getUserFontColour();
        userSpacing = TermsView.getUserSpacing();
        userAlignment = TermsView.getUserAlignment();
